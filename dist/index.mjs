    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (type === "chat" && result.usage) {
                span.setAttribute(SpanAttributes.LLM_USAGE_TOTAL_TOKENS, ((_a = result.usage.input_tokens) !== null && _a !== void 0 ? _a : 0) + ((_b = result.usage.output_tokens) !== null && _b !== void 0 ? _b : 0));
                span.setAttribute(SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, ((_c = result.usage.output_tokens) !== null && _c !== void 0 ? _c : 0));
                span.setAttribute(SpanAttributes.LLM_USAGE_PROMPT_TOKENS, ((_d = result.usage.input_tokens) !== null && _d !== void 0 ? _d : 0));
            }
