...
class CerebrasInstrumentation extends instrumentation.InstrumentationBase {
    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (result.usage) {
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_TOTAL_TOKENS, ((_a = result.usage.prompt_tokens) !== null && _a !== void 0 ? _a : 0) +
                    ((_b = result.usage.completion_tokens) !== null && _b !== void 0 ? _b : 0));
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, (_c = result.usage.completion_tokens) !== null && _c !== void 0 ? _c : 0);
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_PROMPT_TOKENS, (_d = result.usage.prompt_tokens) !== null && _d !== void 0 ? _d : 0);
            }
            ...
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    ...
                    span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.0.content`, result.choices[0].message.content);
                }
                else {
                    span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.0.role`, "assistant");
