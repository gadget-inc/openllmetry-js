...
class CerebrasInstrumentation extends instrumentation.InstrumentationBase {
    constructor(config = {}) {
    ...
    init() {
        const module = new instrumentation.InstrumentationNodeModuleDefinition("@cerebras/cerebras_cloud_sdk", [">=0.9.1"], this.patch.bind(this), this.unpatch.bind(this));
        return module;
    }
    ...
    startSpan({ type, params, }) {
        var _a, _b;
        const attributes = {
            [aiSemanticConventions.SpanAttributes.LLM_SYSTEM]: "Cerebras",
    ...
    _streamingWrapPromise(_a) {
        return tslib.__asyncGenerator(this, arguments, function* _streamingWrapPromise_1({ span, type, promise, }) {
            ...
            if (type === "chat") {
                ...
                try {
                    for (var _s = true, _t = tslib.__asyncValues(yield tslib.__await(promise)), _u; _u = yield tslib.__await(_t.next()), _b = _u.done, !_b; _s = true) {
                        _d = _u.value;
                        _s = false;
                        const chunk = _d;
                        yield yield tslib.__await(chunk);
                        try {
                            message.content += ((_k = (_j = (_h = chunk.choices) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.delta) === null || _k === void 0 ? void 0 : _k.content) || "";
                        }
                        catch (e) {
                            this._diag.debug(e);
                    ...
                    try {
                        if (!_s && !_b && (_c = _t.return)) yield tslib.__await(_c.call(_t));
                    }
                ...
                try {
                    for (var _v = true, _w = tslib.__asyncValues(yield tslib.__await(promise)), _x; _x = yield tslib.__await(_w.next()), _e = _x.done, !_e; _v = true) {
                        _g = _x.value;
                        _v = false;
                        const chunk = _g;
                        yield yield tslib.__await(chunk);
                        try {
                            result.choices[0].text += ((_p = (_o = chunk.choices) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.text) || "";
                        }
                        catch (e) {
                            this._diag.debug(e);
                    ...
                    try {
                        if (!_v && !_e && (_f = _w.return)) yield tslib.__await(_f.call(_w));
                    }
    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (type === "chat" && result.usage) {
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_TOTAL_TOKENS, ((_a = result.usage.input_tokens) !== null && _a !== void 0 ? _a : 0) + ((_b = result.usage.output_tokens) !== null && _b !== void 0 ? _b : 0));
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_COMPLETION_TOKENS, ((_c = result.usage.output_tokens) !== null && _c !== void 0 ? _c : 0));
                span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_PROMPT_TOKENS, ((_d = result.usage.input_tokens) !== null && _d !== void 0 ? _d : 0));
            }
            if ((_f = (_e = result.choices) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.finish_reason) {
                span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.0.finish_reason`, result.choices[0].finish_reason);
            }
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    ...
                    span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.0.role`, "assistant");
                    span.setAttribute(`${aiSemanticConventions.SpanAttributes.LLM_COMPLETIONS}.0.content`, result.choices[0].text || "");
                }
            }
        }
        catch (e) {
...
exports.CerebrasInstrumentation = CerebrasInstrumentation;
